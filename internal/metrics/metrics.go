...
// Package metrics defines Prometheus metrics for the LegatorAgent operator.
//
...
var (
	...
	GuardrailBlocksTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "legator_guardrail_blocks_total",
	...
	EscalationsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "legator_escalations_total",
	...
	ScheduleLagSeconds = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			Name: "legator_schedule_lag_seconds",
